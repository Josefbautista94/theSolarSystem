...
for( let key in solarSystem){
    if(solarSystem[key].ringSystem === true){
    console.log(solarSystem[key])
}
}
  //////////////////////////////
  ...
  const momentunDif = (system.jupiter.velocity * system.jupiter.mass) - (system.pluto.velocity * system.pluto.mass)

  console.log(momentunDif)